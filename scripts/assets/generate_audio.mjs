...
//
// Bakes a handful of high-impact one-shot SFX into 16-bit PCM WAV under
// public/assets/audio/sfx/. (Biome music beds are now curated CC0 Ogg tracks
// under public/assets/audio/music/ — see CREDITS.md — not generated here.)
...
let total = 0;
let count = 0;
// Music beds are no longer generated here: the synth drones read as a constant
// "hum" rather than music, so the biome beds now ship as curated CC0 /
// public-domain Ogg Vorbis tracks under public/assets/audio/music/ (see
// CREDITS.md). The makeBed/BIOMES synth code is retained above for reference and
// as the in-engine fallback floor (audio.ts startMusic), but writes no files.
void makeBed;
void BIOMES;
const sfx = {
  crit: makeCrit(),
